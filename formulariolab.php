    ...
    <div class="group">
        <form method="POST" action=" ">
            ...
            <label for="email"><b>Email</b> <span><em>(requerido)</em></span>
                <input type="email" name="email" class="forma-input" id="email" pattern="\S+@\S+\.\S+"
                    required /></label>
            ...
            <label for="password"><b>Password</b> <span><em>(requerido)</em></span>
                <input type="password" name="password" class="forma-input" id="clave" minlength="4" maxlength="8"
                    required /></label>
